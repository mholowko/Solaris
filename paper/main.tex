...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.32]{paper/plots/Main_Paper/swarmplot.pdf}
    \includegraphics[scale=0.32]{paper/plots/Main_Paper/quantplot.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.32]{paper/plots/Main_Paper/scatter_abc1_FF.pdf}
    \caption{Scatterplot.}

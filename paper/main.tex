...
We believe that the method would be useful for use in desgin of other small genetic parts, but the complexity of the task quickly increases with the size of the analysed sequence.

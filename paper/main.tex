...
% \begin{figure}[t]
% \centering
% \subfloat{\label{main:c}\includegraphics[scale=1]{plots/logo.pdf}}\par\medskip
% \begin{minipage}{.5\linewidth}
% \centering
% \subfloat[]{\label{main:a}\includegraphics[scale=.4]{plots/Patterns.png}}
% \end{minipage}
% \begin{minipage}{.5\linewidth}
% \centering
% \subfloat[]{\label{main:b}\includegraphics[scale=.4]{plots/Hd_Heatmap.png}}
% \end{minipage}
% \begin{minipage}{.5\linewidth}
% \centering
% \subfloat[]{\label{main:b}\includegraphics[scale=.4]{plots/Histogram.png}}
% \end{minipage}
...
%   \caption{Toy example reward histograms.}
%     \label{fig: Simulated reward histogram.}
% \end{figure}

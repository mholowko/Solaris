...
mentioned, as well as existing RBS calculators,do not yet provide uncertainty levels to guide exploration \hl{with the notable exception of ART} \cite{Radivojevic2020} .
...
\hl{To test the reliability of our proposed model, we have generated TIR predictions for all 4096 RBS sequences using the RBS  calculator ver. 2.0 \mbox{\cite{Salis2009}} and evaluated our model using that data.

...
\begin{figure}[!ht]
    \centering
     \includegraphics[scale=0.4]{paper/plots/Supplementary/proj_scatter_abc1_FF.pdf}
    \includegraphics[scale=0.6]{paper/plots/Supplementary/swarmplot_proj.pdf}
    \caption{Exploration v.s. Exploitation.}
\end{figure}

\input{mixture_absGau}

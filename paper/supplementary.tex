...
\begin{figure}[!ht]
   ...
   \caption{\textbf{Exploration-Exploitation scores illustration.} The orange points show the predicted STD and TIR (with the setting of Figure \ref{fig: Scatterplot}) for test data points (Recommendation in Round 1-3), which are projected to the diagonal line. The projected values are the exploration-exploitation scores shown in Figure \ref{fig: Swarmplot and Quantplot}C.}
...
\begin{figure}[!ht]
   ...
   \caption{\textbf{Sequence logo for all tested sequences.} Compared to \ref{fig:Library characteristics}A there are no significant biases at each position.}
   \label{fig: All_logo}
\end{figure}
...
\begin{figure}[!ht]
   ...
   \caption{\textbf{Histogram of standard deviations.} Average raw standard deviations for each of the tested RBSs are  shown.}
   \label{fig: SDhist}
\end{figure}

...
\begin{figure}[!ht]
    ...
    \caption{Swarm plot showing the obtained raw TIRs divided into RBS groups.
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale = 0.4]{plots/Supplementary/scatter_abc1_TT_0.pdf}
    \includegraphics[scale = 0.4]{plots/Supplementary/scatter_abc1_TT_1.pdf}
    \includegraphics[scale = 0.4]{plots/Supplementary/scatter_abc1_TT_2.pdf}
    \includegraphics[scale = 0.4]{plots/Supplementary/scatter_abc1_TT_3.pdf}
    \caption{scatter abc1 TT}
...
\begin{figure}[!ht]
    ...
    The core region is highligthed in light green and the lines are rolling averages for each base. 
    The top dotted line shows the TIR for the benchmark sequence, where dots represent a change at a given position to a given base,
...
\begin{figure}[!ht]
   \centering
   \includegraphics[width=\textwidth]{plots/Supplementary/All_logo.pdf}
...
\begin{figure}[!ht]
   \centering
    \includegraphics[scale=0.4]{plots/Supplementary/proj_scatter_abc1_FF_0.pdf}
    \includegraphics[scale=0.4]{plots/Supplementary/proj_scatter_abc1_FF_1.pdf}
    \includegraphics[scale=0.4]{plots/Supplementary/proj_scatter_abc1_FF_2.pdf}
   \caption{Exploration v.s. Exploitation.}
\end{figure}

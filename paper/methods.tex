...
\begin{figure}
    ...
    The confidence intervals are shown with predicted mean of $\pm$ 1.96 standard deviation.
...
Then we add the recommended data point ($x = 2$) into the training data set with the predicted mean of that point as label (note it is not the true label, i.e. observation), and update the predicted standard deviation and then we finally update the UCB scores. 

...
color_dict['consensus'] = tab10.colors[4]
color_dict['reference'] = tab10.colors[5]
color_dict['bps_core'] = tab10.colors[6]
color_dict['bps_noncore'] = tab10.colors[7]
color_dict['uni random'] = tab10.colors[8]
color_dict['prob random'] = tab10.colors[9]

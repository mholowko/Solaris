...
# 23/04/2021 Update: add step names in comments
...
if '1' in approach:
    how_to_normalize = 'roundRep' # choices:  'plateRep', 'roundRep', 'all'
else: # default is all
    how_to_normalize = 'all'
...
Generated_File_Path = '/data/pipeline_data/Results_' + approach + '.csv'
...
#         + data_format + '_log' + str(Log_flag) +'_Round' + str(to_design_round) + '.csv'
# else:

...
\subsection{First Round of Designs}
...
\begin{enumerate}
    ...
    \item 30 RBS sequences fully and uniformly randomised (equal probability of choosing each letter for each base) 
